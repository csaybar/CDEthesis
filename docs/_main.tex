...
\begin{table}[!h]
\centering
\caption{Percentage of IPs with PA or UA metric values below to 0.1 (low), between 0.1 and 0.9 (int), and above 0.9 (high).}
\label{tab:table66}
\resizebox{\textwidth}{!}{
...
\multicolumn{1}{|l|}{\multirow{4}{*}{\textbf{CloudSEN12}}} & ResNet-18 & \textbf{0.072} & \textbf{0.133} & \textbf{0.918} & \textbf{0.935} & \textbf{0.950} & 0.749 & \textbf{0.697} & \textbf{0.631} \\ \cline{2-10} 
\multicolumn{1}{|l|}{} & DKL & \textbf{0.081} & \textbf{0.147} & 0.730 & 0.794 & 0.825 & 0.702 & 0.610 & 0.540 \\ \cline{2-10} 
